/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/proj/esdt_sdk/gnu_abe/ABE/builds/lin/arm/arm-none-eabi/snapshots//gcc-linaro-snapshot-6.2-2016.11/gcc/config/arm/arm.md'.  */
